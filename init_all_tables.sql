...
CREATE TABLE IF NOT EXISTS property_listing (
    ...
    status_listing VARCHAR(20) DEFAULT 'Tersedia',
...
('English', 'Beginner', 'Belajar bahasa Inggris dasar untuk pemula.', '🇬🇧'),
('English', 'Intermediate', 'Bahasa Inggris level menengah.', '🇬🇧'),
('Japanese', 'Beginner', 'Belajar bahasa Jepang dasar.', '🇯🇵'),
('Korean', 'Beginner', 'Belajar bahasa Korea dasar.', '🇰🇷'),
('Arabic', 'Beginner', 'Belajar bahasa Arab dasar.', '🇸🇦'),
('Mandarin', 'Beginner', 'Belajar bahasa Mandarin dasar.', '🇨🇳'),
('French', 'Beginner', 'Belajar bahasa Prancis dasar.', '🇫🇷'),
('German', 'Beginner', 'Belajar bahasa Jerman dasar.', '🇩🇪'),
('Spanish', 'Beginner', 'Belajar bahasa Spanyol dasar.', '🇪🇸'),
('Thai', 'Beginner', 'Belajar bahasa Thailand dasar.', '🇹🇭');
...
INSERT INTO vocabulary (id_course, kata, terjemahan, pelafalan, contoh_kalimat, kategori_kata) VALUES
(3, 'こんにちは', 'Halo', 'Konnichiwa', 'こんにちは、元気ですか？', 'Greeting'),
...
INSERT INTO vocabulary (id_course, kata, terjemahan, pelafalan, contoh_kalimat, kategori_kata) VALUES
(6, '你好', 'Halo', 'Ni hao', '你好，你叫什么名字？', 'Greeting'),
(6, '谢谢', 'Terima kasih', 'Xie xie', '非常谢谢你！', 'Phrase'),
(6, '水', 'Air', 'Shui', '我要喝水。', 'Noun'),
(6, '书', 'Buku', 'Shu', '这是我的书。', 'Noun'),
(6, '吃', 'Makan', 'Chi', '我们一起吃饭吧。', 'Verb'),
(6, '去', 'Pergi', 'Qu', '我要去学校。', 'Verb'),
(6, '漂亮', 'Cantik', 'Piaoliang', '这个地方很漂亮。', 'Adjective'),
(6, '一', 'Satu', 'Yi', '给我一个。', 'Number'),
(6, '大', 'Besar', 'Da', '这个房子很大。', 'Adjective'),
(6, '早上好', 'Selamat pagi', 'Zaoshang hao', '早上好，老师！', 'Greeting');

INSERT INTO vocabulary (id_course, kata, terjemahan, pelafalan, contoh_kalimat, kategori_kata) VALUES
(7, 'Bonjour', 'Halo', 'bon-ZHOOR', 'Bonjour, comment allez-vous?', 'Greeting'),
...
(7, 'Un', 'Satu', 'uhn', 'Un cafe, s''il vous plait.', 'Number'),
(7, 'Grand', 'Besar', 'gron', 'C''est une grande maison.', 'Adjective');

INSERT INTO vocabulary (id_course, kata, terjemahan, pelafalan, contoh_kalimat, kategori_kata) VALUES
(8, 'Hallo', 'Halo', 'HA-loh', 'Hallo, wie geht es Ihnen?', 'Greeting'),
(8, 'Danke', 'Terima kasih', 'DUNG-keh', 'Danke schon!', 'Phrase'),
(8, 'Wasser', 'Air', 'VA-ser', 'Ich mochte Wasser.', 'Noun'),
(8, 'Buch', 'Buku', 'bookh', 'Das ist ein gutes Buch.', 'Noun'),
(8, 'Essen', 'Makan', 'E-sen', 'Wir essen zusammen.', 'Verb'),
(8, 'Schon', 'Cantik / Indah', 'shurn', 'Der Garten ist schon.', 'Adjective'),
(8, 'Eins', 'Satu', 'ains', 'Eins, zwei, drei!', 'Number'),
(8, 'Gross', 'Besar', 'grohs', 'Das Haus ist gross.', 'Adjective');

INSERT INTO vocabulary (id_course, kata, terjemahan, pelafalan, contoh_kalimat, kategori_kata) VALUES
(9, 'Hola', 'Halo', 'OH-lah', 'Hola! Como estas?', 'Greeting'),
...
(9, 'Hermoso', 'Cantik / Indah', 'er-MOH-soh', 'El jardin es hermoso.', 'Adjective'),
